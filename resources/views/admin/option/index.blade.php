...
@section('main')
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-auto ms-auto">
            <a class="btn btn-success" href="{{ route('option.create') }}">Thêm</a>
        </div>     
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
            ...
            <table class="table">
                <thead>
                  <tr>
                    ...
                    <th width="15%" scope="col">Tên hạng mục tùy chọn</th>
                    <th width="" scope="col">Giá trị của hạng mục tùy chọn</th>
                    ...
                    @if (count($items) > 0)
                        @foreach ($items as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('option.destroy', ['option' => $item->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <a class="btn btn-primary btn-sm" href="{{ route('option.edit', ['option' => $id]) }}">Sửa</a>
